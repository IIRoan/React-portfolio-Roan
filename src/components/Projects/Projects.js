...
export default function Projects() {
  return(
                ...
                <a href="iroan.net"><img className={stylesprojects.zoom} src={react} alt="React"/></a>
                <a href="https://iroan.net"><img className={stylesprojects.zoom} src={mainweb} alt="Mainweb"/></a>
                </div>
  );
}
